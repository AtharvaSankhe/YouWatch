...
class _VideoDetailsState extends State<VideoDetails> {
  ...
  void getlocationData() async{
    ...
    Fluttertoast.showToast(msg: '$place');
    locationController.text = place.subLocality.toString();
  }
                ...
                : Column(
                    ...
                    children: [
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          filled:
                              descriptionController.text != '' ? true : false,
                          fillColor: Colors.grey.shade100,
                        ...
                        child: DropdownButtonFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            contentPadding: const EdgeInsets.all(
                                15), // Remove the padding within the field
                          ),
                        ...
                        child: InkWell(
                          onTap: () {
                            if (titleController.text.isNotEmpty &&
                                ...
                                category != '') {
                              uploadController.saveVideoInfoToFirebase(
                            ...
                            setState(() {
                              GlobalController.instance.showProgessbar.value =
                                  true;
                            });
                          },
                          child: Container(
